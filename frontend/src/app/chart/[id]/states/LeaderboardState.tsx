        ...
        <div className="relative z-10 w-full flex flex-col md:flex-row items-stretch gap-6 md:gap-0">
            <div className="flex-1 flex items-center justify-center p-6">
                <div className="flex flex-col items-center gap-6 text-center">
                    ...
                    <div>
                        <h1 className="text-4xl font-bold text-white drop-shadow-lg">Leaderboard</h1>
                        <p className="mt-2 text-white/70 text-lg">
                            {chart.properties.title || 'Untitled Chart'}
                        </p>
                    </div>

                    <button
                        onClick={onBack}
                        className="px-8 py-4 rounded-full text-sm font-semibold bg-white/20 hover:bg-white/30 text-white transition-colors backdrop-blur-sm border border-white/30"
                    >
                        ← Back
                    </button>
                </div>
