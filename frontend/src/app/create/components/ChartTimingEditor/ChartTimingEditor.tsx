...
function ChartTimingEditor({
    ...
    const { handleDragStart, handlePointerMove, handlePointerUp, handlePointerCancel } =
        useRegionUpdate({
            timingsRef,
            waveformWidthRef,
            getDuration,
                    ...
                    if (e.code === 'Space') {
                        ...
                        if (selectedIndex !== null) {
                            wsRef.current?.seekTo(
                                timings[selectedIndex].start / wsRef.current.getDuration()
                            );
                        }
                        togglePlayPause();
                    }
            ...
            >
                ...
                >
                    ...
                    <div
                        ...
                        onPointerDown={e => {
                            const isRegionClick = !!(e.target as HTMLElement).closest(
                                '[data-region]'
                            );
                            if (!isRegionClick) {
                                setSelectedIndex(null);
