...
const SyncMapAlignmentEditor = forwardRef<SyncMapAlignmentEditorHandle, SyncMapAlignmentEditorProps>(
    function SyncMapAlignmentEditor(
        ...
        useImperativeHandle(ref, () => ({
            seekTo(time: number) {
                ...
                // Scroll so the seek point is visible in the regions container
                ...
                if (!duration) return;
                const x = (time / duration) * waveformWidth;
